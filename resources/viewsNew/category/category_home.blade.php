			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<div class="row">
						<div class="col-md-6">
							<div class="btn-group">
								<button id="sample_editable_1_new" class="btn sbold green" onclick="window.location.href='{{ url('/')}}/add-category'"> Add New Category
						...
						<?php $i = 1; ?>
						   ...
						   <tr>
								...
								<td> 
									...
									<li>
									<a href="{{ url('/')}}/edit-category/{{ $row->category_row_id }}">
									<i class="icon-docs"></i> Edit </a>
									</li>
									<li>
									<a class="deleteLink" deleteID="{{ $row->category_row_id }}" href="javascript:void(0)">
 ...
 $('.deleteLink').click( function() {
  if( confirm('Are you sure to Delete ? ') )
  {
   var deleteID = $(this).attr('deleteID');   
    window.location.href = "{{ url('/')}}/delete-category/" + deleteID;    
  }
