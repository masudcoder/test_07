		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-dark">
					...
					<span class="caption-subject bold uppercase"> Product Types List</span>
				</div>
				<div class="actions">
			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<div class="row">
						<div class="col-md-6">
							<div class="btn-group">
								<button id="sample_editable_1_new" class="btn sbold green" onclick="window.location.href='{{ url('/')}}/add-product-type'"> Add New Product Type
				...
				<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
					<thead>
						<tr>
							<th> # </th>
							<th style="width:30%"> Product Type Name </th>	
							<th> Description </th>								
							<th> Action </th>			
						</tr>
					</thead>
					<tbody>
					  ...
					  <?php $i = 1; ?>
						   ...
						   <tr>
								...
								<td> {{ $row->product_type_short_description }} </td>								
								<td> 
									<div class="btn-group">
									...
									<li>
									<a href="{{ url('/')}}/edit-product-type/{{ $row->product_type_row_id }}">
									<i class="icon-docs"></i> Edit </a>
									</li>
									<li>
									<a class="deleteLink" deleteID="{{ $row->product_type_row_id }}" href="javascript:void(0)">
