			...
			<div class="portlet-body form">                                    
				<form role = "form" method="post" action="{{ url('/')}}/import-template">
				   ...
				   <input type="hidden" name="template_row_id" value="{{ $data['template_info']->template_row_id }}" >
					...
					<div class="form-group" style="padding:30px 0 20px 0">
						<span style="color:#a9a9a9;font-weight:bold;">Here you can map your imported columns to Merchware product data fields. </span>
					</div>
					...
					<div class="form-group">
						<table width="100%" border="0" >
						  ...
						  <td style="width:35%;">Column Header</td> 
						  <td style="width:25%;">Map to</td>
						  <td style="width:35%;padding-left: 35px" >Example Column Value</td> 
						  </tr>
						...
						{ ?>
						  ...
						  <td style="width:35%;padding-right:25px"><?php echo $csvHead->csv_head_name_original; ?>:</td> 
						  <td style="width:25%;">
							<select class="form-control input-medium match_field" name="head_replace_to[]" csv_head_row_id="{{ $csvHead->csv_head_row_id}}" >								  
							   <option value="">Skip (or Rename Field Below)</option>
						  ...
						  <td style="width:35%;">
							...
							<?php 							
							$template_csv_head_values = DB::table('template_csv_values')->where('csv_head_row_id', $csvHead->csv_head_row_id)->take(5)->get();?>
							<?php  
							   //print_r( $template_csv_head_values );
