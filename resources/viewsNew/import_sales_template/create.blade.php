	...
	<div class="col-md-12 ">
		...
		<div class="portlet light bordered">
			...
			<div class="portlet-body form">                                    
				<form role="form" method="post" action="{{ url('/')}}/store-sales-template" enctype="multipart/form-data">
				   {!! csrf_field() !!}
				   <input type="hidden" name="edit_row_id" value="{{ isset($data['single_record']) ? $data['single_record']->collection_row_id : '' }}" >
					<div class="form-body"> 
						...
						<div class="form-group row">							
							<div class="col-md-12">Download a <a href=" {{ url('/')}}/public/csv/sample_sales_data.csv"> sample CSV </a> file to see an example of the format.</div>
						</div>
					</div>
