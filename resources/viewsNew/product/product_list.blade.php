...
<link href="{{asset('/')}}css/assets/global/plugins/icheck/skins/all.css" rel="stylesheet" type="text/css" />
    ...
    <div class="table-scrollable">
        ...
        <table class="table table-striped table-bordered table-hover"  id="product_list">
            ...
            <tbody>
                ...
                @endforeach  
                <tr><td colspan="10" style="text-align: center"> {{ $data['products_list']->links() }} </td><td colspan="22"></td></tr>                
            </tbody>
        </table>
    </div>
    </form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ URL::to('importExcel') }}" id="importCsvProductsForm" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="csv_format_note">Download a <a href="{{ url('/')}}/csv/product_template.csv">Sample CSV </a> file to see an example of the format.</div>
                        {!! csrf_field() !!}
...
@section('select2js')
<script src="{{asset('/')}}css/assets/global/plugins/icheck/icheck.min.js" type="text/javascript"></script>
...
<script src="{{ url('css/assets/global/plugins/ladda/spin.min.js') }}" type="text/javascript"></script>
<script src="{{ url('css/assets/global/plugins/ladda/ladda.min.js') }}" type="text/javascript"></script>
<script src="{{asset('/')}}css/assets/pages/scripts/form-icheck.min.js" type="text/javascript"></script>
<script src="{{asset('/')}}css/assets/pages/scripts/ui-buttons.min.js" type="text/javascript"></script>
@endsection 
