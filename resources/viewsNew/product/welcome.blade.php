...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('/')}}/public/css/assets/pages/css/login-5.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">                    
					<div class="login-bg" style="background-image:url({{asset('/')}}/public/css/assets/pages/img/login/bg1.jpg)">
                        <img class="login-logo" src="{{asset('/')}}/public/css/assets/pages/img/login/logo.png" /> </div>
                </div>
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        <h1>Merchware Login</h1>
                        <p> Merchware is a product managment platform focused on the on-demand merchandise market. <a href="#">Learn More</a> or <a href="{{ url('/')}}/register">Signup</a>.</p>
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Copyright &copy; Nymbl Inc. 2016</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<![endif]-->
        ...
        <script src="{{asset('/')}}/public/css/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="{{asset('/')}}/public/css/assets/global/scripts/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="{{asset('/')}}/public/css/assets/pages/scripts/login-5.min.js" type="text/javascript"></script>
