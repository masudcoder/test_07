...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ url('css/assets/global/plugins/ladda/ladda-themeless.min.css') }}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{asset('/')}}css/assets/layouts/layout6/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="{{asset('/')}}css/assets/layouts/layout6/css/custom.min.css" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <script src="{{asset('/')}}css/assets/layouts/layout6/scripts/layout.min.js" type="text/javascript"></script>
...
.page-sidebar .page-sidebar-menu>li>a>i, .page-sidebar-closed.page-sidebar-fixed .page-sidebar:hover .page-sidebar-menu>li>a>i {
 ...
 <script type="text/javascript">
    $(document).ready(function() {
        ...
        var modulename = segments[3];
        var sectionName = '';
        sectionName = segments[4];
        console.log(modulename + ' - ' +  sectionName);
        
        /*if((modulename == 'home') || (modulename =='manage-product')) {
            $('#listProduct').addClass('active open');
        } else if(modulename == 'add-product') {
            $('#addProduct').addClass('active open');
        } else if(modulename == 'manage-collection') {
            $('#manageCollection').addClass('active open');
        } else if(modulename == 'reports') {
            $('#productReports').addClass('active open');
        } else if(modulename == 'manage-export-template') {
            $('#exportTemplate').addClass('active open');
        } else if(modulename == 'manage-import-template') {
            $('#importTemplate').addClass('active open');
        } else if(modulename == 'manage-sales-template') {
            $('#salesTemplate').addClass('active open');
        } else if(modulename == 'billing') {
            $('#billIng').addClass('active open');
        } else if(modulename == 'apikey') {
            $('#apiKey').addClass('active open');
        } else if(modulename == 'my-profile') {
            $('#myAccount').addClass('active open');
        } else {
            $('#managePreset').addClass('active open');
        }*/


        if((modulename == 'manage-import-template') || (modulename == 'import-product-by-vendor') || (modulename == 'manage-vendor-template') || (sectionName =='import') || (modulename == 'import-artist') || (modulename == 'manage-artist-template')) {
            $('#manage_import_product').addClass('active open');
        } 

        if((modulename == 'import-product-by-vendor') || (modulename == 'manage-export-template') ) {
            $('#manage_export_product').addClass('active open');
        } 

        if((modulename == 'manage-product') || (modulename == 'manage-vendor-product') ) {
            $('#manage_products').addClass('active open');
        } 

        if((modulename == 'manage-vendor') || (modulename == 'manage-price-type') || (modulename == 'manage-folder') || (sectionName =='manage-description') || (modulename == 'manage-category') || (modulename == 'manage-product-type') || (modulename == 'manage-tag-group') || (modulename == 'manage-tag') || (modulename == 'integrations')) {
            $('#managePreset').addClass('active open');
        } 
