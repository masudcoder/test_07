			...
			<div class="portlet light bordered">
				<div class="portlet-title">
					<div class="caption font-dark">
						...
						<span class="caption-subject bold uppercase"> Collections List</span>
					</div>
				...
				<div class="portlet-body">
					<div class="table-toolbar">
						<div class="row">
							<div class="col-md-6">
								<div class="btn-group">
									<button id="sample_editable_1_new" class="btn sbold green" onclick="window.location.href='{{ url('/')}}/add-collection'"> Add New Collection
								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu" role="menu">
											<li>
												<a href="{{ url('/edit-collection/'.$row->collection_row_id ) }}">
													<i class="icon-docs"></i> Edit
												</a>
											</li>
											<li>
												<a class="deleteLink" deleteID="{{ $row->collection_row_id }}" href="javascript:void(0)">
	...
	<script type="text/javascript">
        $('.deleteLink').click( function() {
            if( confirm('Are you sure to Delete ? ') )
            {
                ...
                window.location.href = "{{ url('/')}}/delete-collection/" + deleteID;
            }
