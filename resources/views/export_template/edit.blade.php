		...
		<div class="portlet light bordered">
			...
			<div class="portlet-body form">                                    
				<form role = "form" method="post" action="{{ url('/')}}/store-export-template">
				   {!! csrf_field() !!}
				   <input type="hidden" name="template_row_id" value="{{ isset($data['single_record']) ? $data['single_record']->template_row_id : '' }}" >
					<div class="form-body">                                           
						...
						<div class="row">
							<div class="col-md-6">
							<?php 
							$available_field_value = json_decode($data['single_record']->template_fields, true); 
							$available_field_str = '';
							foreach($available_field_value as $key=>$val) {								
							$available_field_str .= '<div class="form-group" style="clear:both;padding-top:10px"><div style="float:left;padding-right:10px"><input type="text" class="form-control input-small"  name="template_fields[]" value="' . $val . '"></div><div style="float:left"><input type="text" class="form-control input-small"  name="template_fields_values[]" value="{' . $val . '}"> </div><div style="float:left;padding:7px 0 0 10px"><a href="javascript:void(0)" class="deleteOptionLink"> Delete </a> </div></div>';
							}
							?>
								Selected Fields
							...
							<div class="col-md-6">							
								...
								<div class="available_fields">
									<a href="javascript:void(0)" class="available_field_link" available_field_value="sales_amount">Sales Amount,</a>
									<a href="javascript:void(0)" class="available_field_link" available_field_value="quantity">Quantity,</a>
									<a href="javascript:void(0)" class="available_field_link" available_field_value="customer">Customer</a>
								</div>
...
$( document ).ready(function() {
   $(".selected_fields").append('<?php echo $available_field_str;?>');   
