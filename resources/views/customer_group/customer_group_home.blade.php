			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<div class="row">
						<div class="col-md-6">
							<div class="btn-group">
								<button id="sample_editable_1_new" class="btn sbold green" onclick="window.location.href='{{ url('/')}}/add-price-type'"> Add New Price Level
				...
				<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
					...
					<tbody>
					 ...
					 <?php $i = 1; ?>
						   ...
						   <tr>
								<!--<td> <?php echo $i; $i++; ?></td>-->
								<td> {{ $row->customer_group_row_id }}</td>
								<td> {{ $row->customer_group_name }} </td>
								<td> {{ $row->customer_group_short_description }} </td>
								<td> 
									<div class="btn-group">
									...
									<li>
									<a href="{{ url('/')}}/edit-price-type/{{ $row->customer_group_row_id }}">
									<i class="icon-docs"></i> Edit </a>
									</li>
									<li>
									<a class="deleteLink" deleteID="{{ $row->customer_group_row_id }}" href="javascript:void(0)">
 ...
 $('.deleteLink').click( function() {
  if( confirm('Are you sure to Delete ? ') )
  {
   var deleteID = $(this).attr('deleteID');   
    window.location.href = "{{ url('/')}}/delete-price-type/" + deleteID;    
  }
