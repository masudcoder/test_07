		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-dark">
					...
					<span class="caption-subject bold uppercase">Vendor Templates List</span>
				</div>
				<div class="actions">
			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<div class="row">
						<div class="col-md-6">
							<div class="btn-group">
								<button id="sample_editable_1_new" class="btn sbold green" onclick="window.location.href='{{ url('/')}}/add-import-template'"> Add New Vendor Template
				...
				<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
					<thead>
						<tr>
								...
								<th style="width:100px"> More Actions </th>					
						</tr>
					</thead>
					<tbody>
							...
							@foreach($data['records']  as $row) 
						   	<tr class="odd gradeX" style="color:#808080">		
								...
								<td> 
									...
									<li>
								\d	<a class="deleteLink" deleteID="{{ $row->template_row_id }}" href="javascript:void(0)">
