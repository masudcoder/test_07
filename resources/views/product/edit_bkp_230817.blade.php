							...
							<div class="tab-pane" id="tab_dynamic_field">
								<div class="form-body dynamic-section">	
									...
									@if(count($data['dynamic_fields']))
									    @foreach($data['dynamic_fields'] as $row)
										<?php if($row->field_value == '') continue; ?>
											<div class="form-group" id="meta_first_option">		
												<label class="col-md-2 control-label"><?php if($i == 0) :?>Dynamic Fields:<?php endif; ?></label>
												<div class="col-md-4">
													<input type="text" class="form-control" value="{{ $row->field_name }}" name="dynamic_fields[]"  placeholder="Name">											
												</div>
												<div class="col-md-4">
													<input type="text" class="form-control" value="{{ $row->field_value }}" name="dynamic_fields_value[]" placeholder="Value">											
												</div>
