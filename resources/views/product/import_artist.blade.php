					...
					<div class="tabbable-bordered">
						...
						<div class="tab-content">						
							<div class="tab-pane active" id="tab_general">								
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-4">
											<div style="padding:5px 0 0 0">
												<a href="#copyProduct" style="text-decoration:none" id="get_all_products" data-toggle="modal"><i class="fa fa-copy"></i> Copy Product</a>
											</div>
										</div>	
									</div>									
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" name="vendor_sku" placeholder=""> </div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" name="upc" placeholder="" > 
										</div>
									</div>
								...
								<div class="form-group">
									<label class="col-md-2 control-label">Artist Name:
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<div style="float:left;"><input type="text" name="aku_code" maxlength="5"  id="aku_code" class="form-control input-medium"  placeholder="5 digit # only"></div><div class="part-or-3">  <button type="button" id="aku_code_btn" class="btn green btn-large" style="width:225px">Generate Art Keeping Unit1 (AKU)</button></div>											
								...
								<div class="form-group">
									<label class="col-md-2 control-label">AKU2:</label>
									<div class="col-md-10">
										<div style="float:left;"><input type="text" name="aku2_code" maxlength="5"  id="aku2_code" class="form-control input-medium"  placeholder="5 digit # only"></div><div class="part-or-3">  <button type="button" id="aku2_code_btn" class="btn green btn-large" style="width:225px">Generate Art Keeping Unit2 (AKU)</button></div>											
										<br/><div style="clear:both;padding:5px 0 0 0;color:red" id="aku_code2_status"> </div>
									</div>			
								</div>		
								...
								<div class="form-group">
									...
									<div class="col-md-10">		
										...
										<textarea class="wysihtml5 form-control" rows="8" id="description_new" name="description"></textarea>											
									</div>
								</div>										
								...
								<div class="form-group" style="padding-top:0px">
									...
									<div class="col-md-10">
										<input type="text" name="production_art_url_1" class="form-control" >
									</div>
								</div>
								...
								<div class="form-group" style="padding-top:0px">
									...
									<div class="col-md-10">
										<input type="text" name="production_art_url_2" class="form-control" >
									</div>
								</div>	
								...
								<div class="form-group" style="padding-top:0px">
									...
									<div class="col-md-10">
										<input type="text" name="print_mode" class="form-control input-medium" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<input type="text" name="print_location" class="form-control input-medium" >
									</div>
								</div>	
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<input type="text" name="print_location2" class="form-control input-medium">
									</div>
								</div>
							</div>
							...
							<div class="tab-pane" id="tab_shipping">
								<div class="form-body shipping-section">
									...
									<div class="form-group">
										...
										<div class="col-md-4"> 
											<input type="text" class="form-control" id="ship_width"  name="ship_width" placeholder="0.00" >
										</div>
										...
										<div class="col-md-6">
											<div class="part-or-3">
												<div class="input-group-btn" class="col-md-4" style="float:left;width:110px">
													...
													<input type="hidden" name="ship_width_unit" id="ship_width_unit" value="" />
												</div>
											</div>
										</div>											
									</div>	
							...
							<div class="tab-pane" id="tab_meta">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea class="form-control maxlength-handler" rows="5" name="product_meta_keyword" maxlength="1000"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Meta Description:</label>
										<div class="col-md-10">
											<textarea class="form-control maxlength-handler" rows="5" name="product_meta_description" maxlength="255"></textarea>
...
<div class="row">
	<div class="col-md-12">
		<div id="copyProduct"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
						<h4 class="modal-title">Click on the Product which you want to copy</h4>
					</div>			
								...
								<div class="portlet light bordered">
									...
									<div class="portlet-body">
										...
										<tbody>
											...
											<td style="text-align:left;padding-left:10px">{{ $row->product_price }}</td> 
											<td>
												<a href="{{ url('/')}}/add-product/{{ $row->product_row_id }}" > Copy </a>
											</td>
											</tr>						
											@endforeach
										</tbody>
...
@section('after-app-js')
	...
	$('#get_all_products') . click( function() {
			var url = "{{ url('/') }}";
			$.ajax({
...
$("#aku_code").keydown(function (e) {
	...
	$('#aku2_code').blur( function() {	
	
		var aku2_code =  $(this).val();		
		if(!aku2_code)
		return;
		
		if( aku2_code.length <5 )
		{
		   $('#aku2_code_status').html('Must be 5 digit #');
			$('#aku2_code').val('');						
			return;			
		}
		
		$.ajax({
				url: "{{ url('is_valid_aku2_code') }}/" + aku2_code,
				type: "GET",	
				dataType:"html",
				success: function(data){
					if(data == 'exist')
					{
						$('#aku2_code_status').html('The code is already exist, Please choose another!');
						$('#aku2_code').val('');
					}
					else
					$('#aku2_code_status').html('');
				},
				
            });
	});

	$('#aku2_code_btn') . click(function() {
		$.ajax({
				url: "{{ url('generate_aku2_code') }}",
				type: "GET",			
				success: function(data){
					$('#aku2_code').val(data['aku2_code']);
					$('#aku2_code_status').html('');
