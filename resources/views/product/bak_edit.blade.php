											...
											<div action="{{ url('/')}}/upload-secondary-image" class="dropzone dropzone-file-area sortable" id="productSecondaryImagesDropzone" style="margin:0; width: 400px; margin-top: 0px;background-color:#f1f1f1"">
												...
												<div class="dz-default dz-message"><span></span></div>			
												 <?php
												  ...
												  for($i=0; $i<count($data['product_secondary_images']); $i++) {
												    
												  ?>												
													<div id="secondary_image_<?php echo $i;?>" class="dz-preview dz-processing dz-image-preview dz-success dz-complete"> 
														<div class="dz-image">
														  <img data-dz-thumbnail=""  alt="product image" src="{{ url('/')}}/public/uploads/product_images/{{$data['user_id']}}/<?php echo $data['product_secondary_images'][$i] ?>" /> 														  
														</div>  
														<div class="dz-error-mark">   
									...
									<div class="form-group" style="padding-top:20px">
										...
										<div class="col-md-10">
											<div action="{{ url('/')}}/upload-design-image" class="dropzone dropzone-file-area" id="HireImageDropzone" style=" margin:0; width: 400px; margin-top: 0px;background-color:#f1f1f1"">
												...
												<div class="dz-default dz-message"><span></span></div>	
												@if($data['single_record']->uploaded_design_image)
													<div id="uploaded_design_image_box" class="dz-preview dz-processing dz-image-preview dz-success dz-complete design-image-preview "> 
														<div class="dz-image">
															<img data-dz-thumbnail="" alt="product image" src="{{ url('/')}}/public/uploads/product_images/{{ $data['user_id']}}/{{ $data['single_record']->uploaded_design_image }}"  /> 
														</div>  
														<div class="dz-error-mark">   
															<svg width="54px" height="54px" viewBox="0 0 54 54" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">      <title>Error</title>      <defs></defs>
																<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage"> 
														...
														<a href="javascript:;" '=""  class="btn red btn-sm btn-block design-image-delete">Remove</a>
													</div>
												@endif	
											</div>
										</div>
							...
							<div class="tab-pane" id="tab_meta">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea class="form-control maxlength-handler" rows="8" name="product_meta_keyword" maxlength="1000">{{  $data['single_record']->product_meta_keyword }}</textarea>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea class="form-control maxlength-handler" rows="8" name="product_meta_description" maxlength="255">{{  $data['single_record']->product_meta_description }}</textarea>
